...
////////////////////////////////////////////////////////////
var EventBetterLogger = (function (_super) {
    __extends(EventBetterLogger, _super);
    function EventBetterLogger(userService) {
        var _this = _super.call(this) || this;
        _this.userService = userService;
        return _this;
    }
    EventBetterLogger.prototype.log = function (message) {
        var name = this.userService.user.name;
        _super.prototype.log.call(this, "Message to " + name + ": " + message);
    };
    return EventBetterLogger;
}(logger_service_1.Logger));
EventBetterLogger = __decorate([
    core_1.Injectable(),
...
Provider5Component = __decorate([
    core_1.Component({
        selector: 'provider-5',
        template: template,
        providers: [user_service_1.UserService, { provide: logger_service_1.Logger, useClass: EventBetterLogger }]
    }),
    __metadata("design:paramtypes", [logger_service_1.Logger])
], Provider5Component);
...
var Provider6aComponent = (function () {
    function Provider6aComponent(newLogger, oldLogger) {
        ...
        oldLogger.log('Hello from OldLogger (but we want NewLogger)');
...
var Provider9Component = (function () {
    /*
        //FAIL! Can't inject using the interface as the parementer type
